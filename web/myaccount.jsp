<%-- 
    Document   : myaccount
    Created on : Mar 7, 2024, 8:45:36 PM
    Author     : admin
--%>
                        ...
                        <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="shop_detail?productID=2">Shop Detail</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="account-box">
                                <div class="service-box">
                                    <div class="service-icon">
                                        <a href="cart?customerID=${sessionScope.customerID}"> <i class="fa fa-gift"></i> </a>
                                    </div>
