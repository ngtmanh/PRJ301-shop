...
public class submit extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            ArrayList<OrderDetails> list_id = db.get_list_orderDetailID_byCustomer(Integer.parseInt(customerID));
            //PrintWriter out = response.getWriter();out.print(list_id);
            for (OrderDetails od : list_id) {
                
                Order o = new Order();
                o.setPaymethod(paymentMethod);
                o.setOrderDetaiID(od.getOrderDetailID());
                
                db.add_order(o);
            }
            request.setAttribute("msg", "Order SuccessFull");
