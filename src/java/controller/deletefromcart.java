...
public class deletefromcart extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            //PrintWriter out = response.getWriter();out.print(customerID);
            db.deleteOrderDetails(Integer.parseInt(id));
            ArrayList<OrderDetails> list = db.get_list_OrderDetails(Integer.parseInt(customerID));
