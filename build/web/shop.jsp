<%-- 
    Document   : shop
    Created on : Mar 7, 2024, 8:58:34 PM
    Author     : admin
--%>
                                    ...
                                    <form action="shop" method="post">
                                        <div class="list-group-collapse sub-men">
                                            ...
                                            <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                                <div class="list-group" name="nameproduct">
                                                    <a href="shop?categoryID=1" class="list-group-item list-group-item-action active" value="T-shirts">T-shirts <small class="text-muted">(50)</small></a>
                                    ...
                                    <div class="list-group-collapse sub-men">
                                        ...
                                        <div class="collapse" id="sub-men2" data-parent="#list-group-men">
                                            <div class="list-group">
                                                ...
                                                <a href="shop?categoryID=3" class="list-group-item list-group-item-action">Sneakers <small class="text-muted">(20)</small></a>
